...
#include "FatFs/ff.h"		/* Obtains integer types for FatFs */
...
// SD_SCK PB13		-> CK
// SD_CS PA11		-> CS
// SD_CD PA12		-> Card Detect
// SD_OFF PA13		-> SD Off

#define DO_INIT()					/* Initialize port for MMC DO as input */
#define DO			((bool)(PIOB->PIO_PDSR & (0x01U << PIO_PDSR_P11_Pos)))	/* Test for MMC DO ('H':true, 'L':false) */

#define DI_INIT()					/* Initialize port for MMC DI as output */
#define DI_H()		PIOB->PIO_SODR = PIO_SODR_P10_Msk	/* Set MMC DI "high" */
#define DI_L()		PIOB->PIO_CODR = PIO_CODR_P10_Msk	/* Set MMC DI "low" */

#define CK_INIT()					/* Initialize port for MMC SCLK as output */
#define CK_H()		PIOB->PIO_SODR = PIO_SODR_P13_Msk	/* Set MMC SCLK "high" */
#define	CK_L()		PIOB->PIO_CODR = PIO_CODR_P13_Msk	/* Set MMC SCLK "low" */

#define CS_INIT()					/* Initialize port for MMC CS as output */
#define	CS_H()		PIOA->PIO_SODR = PIO_SODR_P11_Msk	/* Set MMC CS "high" */
#define CS_L()		PIOA->PIO_CODR = PIO_CODR_P11_Msk	/* Set MMC CS "low" */
